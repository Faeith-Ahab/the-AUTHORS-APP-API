...
class Company(db.Model):
    ...
    user_type = db.Column(db.String(100), nullable=False)  #  string data type 
    ...
    def get_full_name(self):
        return f"{self.name} {self.origin}"  # note: Space between name and origin
    ...
    def to_dict(self):
        ...
        return {
            ...
            "created_at": self.created_at.strftime("%Y-%m-%d %H:%M:%S"),  # Format created_at as string
        }